      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto px-3 sm:px-6 py-6 sm:py-8 pb-28">
          {isLoading ? (
            ...
            <div className="max-w-7xl mx-auto">
              {/* Welcome header for albums */}
              <div className="mb-8 text-center">
                <div className="bg-black/30 backdrop-blur-sm rounded-xl p-6 border border-white/10">
                  <h2 className="text-2xl font-bold mb-2">Music Collection</h2>
                  <p className="text-gray-300">Discover and listen to music from The Doerfels</p>
                </div>
              </div>
